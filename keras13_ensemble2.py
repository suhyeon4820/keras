...
th_hist = TensorBoard(log_dir='./graph', histogram_freq=0, write_graph=True, write_images=True)
...
model.fit([x1_train, x2_train], [y1_train, y2_train, y3_train], epochs=100, batch_size = 1, validation_split = 0, validation_data = 
          ([x1_val, x2_val], [y1_val, y2_val, y3_val]), callbacks=[early_stopping, th_hist]) 
